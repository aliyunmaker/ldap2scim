...
public class LdapService {
	...
	public static String syncLdapUsertoScim(ScimUser scimUser, Map<String, ScimUser> scimUserServerMap,
		...
		// List<ScimUser> list = ScimUserService.searchScimUser("userName eq \"" +
		// scimUser.getUserName() + "\"", null);
		// if (list.size() > 1) {
		// throw new RuntimeException("find more than 1 user by userName:" +
...
//					JsonUtils.toJsonString(scimUser));
	...
	public static String syncLdapGrouptoScim(ScimGroup scimGroup, Map<String, ScimGroup> scimGroupServerMap,
		...
		// List<ScimGroup> list =
		// ScimGroupService.searchScimGroup("displayName eq \"" +
		// scimGroup.getDisplayName() + "\"", null);
		// if (list.size() > 1) {
		// throw new RuntimeException("find more than 1 group by displayName:" +
